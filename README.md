...
The official release of ngramr is available on [CRAN](http://cran.r-project.org/). At the time of writing, the binaries had not propagated to all of the mirrors, so if you have trouble installing ngramr in the usual way, you can try installing from here on GitHub, as described below.
